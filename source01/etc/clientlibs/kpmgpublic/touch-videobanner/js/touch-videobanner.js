define(['jquery', 'tracking'],
    function($, Tracking) {
        ...
        var TouchVideobanner = function(elem) {
			...
			// Keep the following lines at the bottom of the TouchVideobanner function
            var trck = new Tracking(elem, 'TouchVideobanner');
			$(document).trigger('template.loaded');
        };

        return TouchVideobanner;
    }
);
