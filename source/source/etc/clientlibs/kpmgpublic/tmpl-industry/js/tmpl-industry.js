define(['jquery', 'navigation', 'navflyouta', 'navflyoutb', 'navflyoutc', 'footer'],
        function ($, Navigation, NavFlyoutA, NavFlyoutB, NavFlyoutC, Footer) {
            ...
            var TmplIndustry = function () {
                ...
                $(".kpmg-promo-block").addClass("content-full-height");
                $(".kpmg-promo-block").find("[class*='module-promotional']").addClass("promotional-cell-hover");
